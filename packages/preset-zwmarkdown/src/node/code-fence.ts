...
export const codeFence = createNode<Keys, { languageList?: string[] }>((utils, options) => {
    const style = utils.getStyle(({ extColor, palette, mixin, size, font }) => {
        const { shadow, scrollbar, border } = mixin;
        const { lineWidth, radius } = size;
        return css`
            background-color: ${extColor('backgroundSecondary')};
            color: ${extColor('preCode')};
            font-size: 0.9rem;
            ...
            * {
            ...
            .code-fence_value {
                ...
                ${shadow()};
                cursor: pointer;
                background-color: ${extColor('backgroundSecondaryAlt')};
                position: relative;
                display: flex;
                color: ${extColor('textAccent', 0.87)};
                ...
                & > * {
                    ...
                    &:hover {
                        background: ${extColor('background', 0.8)};
            ...
            .code-fence_select-option {
                ...
                cursor: pointer;
                :hover {
                    background: ${extColor('backgroundSecondaryAlt')};
                    color: ${extColor('textAccent', 0.87)};
                }
            }
            ...
            .code-fence_select {
                ...
                ${shadow()};
                color: ${palette('primary')};
                background-color: ${extColor('backgroundPrimary')};
                border-top: none;
                overflow-y: auto;
                display: flex;
